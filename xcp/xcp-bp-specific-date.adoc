...
summary: Esta solución se basa en un cliente que necesita copiar datos en función de una fecha específica. 
---
= Escaneo y copia de datos específicos basados en fechas
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esta solución se basa en un cliente que necesita copiar datos en función de una fecha específica.  Verifique los siguientes detalles:
