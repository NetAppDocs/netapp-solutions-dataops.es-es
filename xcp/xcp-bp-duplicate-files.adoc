...
summary: NetApp recibió una solicitud para encontrar archivos duplicados de un solo volumen o de varios volúmenes.  NetApp proporcionó la siguiente solución. 
---
= Archivos duplicados
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
NetApp recibió una solicitud para encontrar archivos duplicados de un solo volumen o de varios volúmenes.  NetApp proporcionó la siguiente solución.

Para un solo volumen, ejecute los siguientes comandos:
...
....
Para varios volúmenes, ejecute los siguientes comandos:
